...
DocumentReference? get currentUserReference =>
    loggedIn ? AilbeeUserDataRecord.collection.doc(currentUser!.uid) : null;

AilbeeUserDataRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : AilbeeUserDataRecord.getDocument(
                  AilbeeUserDataRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
